...
> Implement a function to send the random number generated by the Simulated Sensor Kernel Module and reported by EmbeddedLinux/main.py through Bluetooth using a SPP protocol, Android BlueTerm Application
...
>  Create a new Bot and implement under your script EmbeddedLinux/main.py 2 commands, to read data from functionDataSensor and to execute an action under functionDataActuator

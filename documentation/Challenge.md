...
> Clone your code from InternetOfThings101/main.py to EmbeddedLinux/main.py and replace existing functionality/logic under functionDataSensor to use the random number generated by the Simulated Sensor Kernel Module
